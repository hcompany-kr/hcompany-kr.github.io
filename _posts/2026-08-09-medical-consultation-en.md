...
categories: en
permalink: /blog/en/medical-consultation/
date: 2026-08-09
eyebrow: Health
title: "Most of what the doctor said is gone by the parking lot"
description: "Studies put the forgetting rate as high as 80%. What actually gets written down, what you can request, and how to keep the part that does not."
app: true
...
faq:
  - q: "How much of a doctor's explanation do patients typically forget?"
    a: "A range of studies indicates patients forget as much as 80% of the information immediately following a visit. Contributing factors include emotional distress, physical pain, unfamiliar terminology, and limited health literacy — not inattention."
  - q: "Can I get a copy of my medical records?"
    a: "Yes. Under the HIPAA Privacy Rule you have the right to inspect, review and receive a copy of your health and billing records. A provider must act on the request within 30 calendar days, with one permitted extension of up to 30 more days. A few categories can be withheld, such as psychotherapy notes or information compiled for litigation."
  - q: "Does the after-visit summary capture what was said?"
    a: "Only partly. After-visit summaries and record access were introduced to address recall problems, but they are less useful for patients without strong health literacy and they miss much of the nuance — the reassurances a clinician offered, and the questions a patient asked and how they were answered."
  - q: "Am I allowed to record a medical appointment?"
    a: "Recording a conversation you are part of is permitted in most US states, while about a dozen require the consent of everyone present. Practice policies differ from the law, so asking the clinician first is both simpler and better for the relationship."
  - q: "How can I help an elderly parent whose appointments I cannot attend?"
    a: "The goal is to remove reliance on memory. Requesting the after-visit summary and record copies helps, and where the parent is a participant in the conversation, a recording set up in advance means they do not have to operate anything during the appointment."
---
...
<p class="pull">A range of studies indicates patients forget as much as 80% of the information immediately following a visit.</p>
...
## Consent forms cover a narrower slice than people assume
...
**The law.** Recording a conversation you are part of is permitted in most US states; about a dozen require everyone's consent. The rules are covered [separately](https://hcompany-kr.github.io/blog/en/recording-consent-law/).
...
[TalkSafe](https://hcompany-kr.github.io/talksafe/en/) works differently here.
