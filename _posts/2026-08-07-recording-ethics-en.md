...
categories: en
permalink: /blog/en/recording-ethics/
date: 2026-08-07
eyebrow: Thinking
title: "Is it wrong to record a conversation?"
description: "Legal and defensible are not the same question. What actually makes recording feel uncomfortable, and when that discomfort is telling you something true."
app: true
...
faq:
  - q: "Is it morally wrong to record a conversation you are part of?"
    a: "It depends on the situation. Keeping a record of a conversation you took part in is close to supplementing memory. It changes character if the purpose is to draw out something the other person would not have said had they known, or if you intend to use the recording somewhere else."
  - q: "Do I have to tell the other person I am recording?"
    a: "In most US states and in many countries there is no duty to notify when you are a participant. Telling them is usually better for the relationship, and if telling them feels impossible, that difficulty is worth examining rather than ignoring."
  - q: "Is not telling someone the same as hiding it?"
    a: "No. Not telling is a state of silence — if they ask, you answer, and if they notice, it is out. Hiding is designing for concealment. Whether a notification stays visible while recording, and whether it can be switched off, is the practical line between the two."
  - q: "When is recording easiest to justify?"
    a: "When the relationship is not equal, when the facts may later be disputed, and when nothing else would leave a record. Instructions at work, contract discussions, and medical consultations are typical examples."
  - q: "Can I share a recording I legally made?"
    a: "Making a recording and publishing one are treated differently. A lawful recording can still create liability if you share it — defamation and privacy claims are separate matters, and so is the ethical question."
---
...
<p class="pull">Permitted and defensible are not the same thing.</p>
...
[TalkSafe](https://hcompany-kr.github.io/talksafe/en/) settles one part of this by design.
...
Recording law varies by state and country; that side of it is covered [separately](https://hcompany-kr.github.io/blog/en/recording-consent-law/).
