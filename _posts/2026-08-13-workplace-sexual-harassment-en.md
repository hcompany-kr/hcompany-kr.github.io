...
categories: en
permalink: /blog/en/workplace-sexual-harassment/
date: 2026-08-13
eyebrow: Work
title: "Retaliation is its own violation — even if the harassment claim fails"
description: "The 180/300-day clock, what an employer is required to do once you report, and why what happens after you report is often the stronger case."
app: true
...
faq:
  - q: "How long do I have to file a sexual harassment charge with the EEOC?"
    a: "Generally 180 calendar days from the discriminatory act, extended to 300 days where a state or local fair employment practices agency enforces a law prohibiting the same conduct. In harassment cases the clock runs from the last incident, and the EEOC will consider all incidents when investigating — including earlier ones that fall outside the window."
  - q: "Does my employer have to investigate if I complain internally?"
    a: "An employer that receives a harassment complaint through its internal procedures is obligated to conduct a prompt, thorough and impartial investigation. Failing to do so removes the employer's ability to assert the affirmative defense in a later lawsuit and can independently support a finding of liability."
  - q: "What happens if I am punished for reporting?"
    a: "Retaliation is prohibited under Title VII and is a separate violation. It can be proven even where the underlying harassment claim is not successful. During the EEOC process the employer is prohibited from retaliating against the charging party."
  ...
  - q: "What should I be documenting?"
    a: "Dates and descriptions of each incident written the same day, screenshots of messages before they are deleted, the names of anyone present, every communication with HR or management including the dates you reported, and any change in your treatment after reporting."
---
...
<p class="pull">A retaliation claim can succeed even when the harassment claim does not.</p>
...
[TalkSafe](https://hcompany-kr.github.io/talksafe/en/) removes that step entirely.
...
**A notification stays visible on your own screen while recording, and cannot be switched off.** This is for keeping a record of a conversation you are part of. State consent rules are covered [separately](https://hcompany-kr.github.io/blog/en/recording-consent-law/).
