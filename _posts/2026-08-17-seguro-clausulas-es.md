...
categories: es
permalink: /blog/es/seguro-clausulas/
date: 2026-08-17
eyebrow: Contratos
title: "Tienes un mes para decir que la póliza no es lo que te ofrecieron"
description: "El artículo 8 de la Ley de Contrato de Seguro, las cláusulas limitativas que no valen si no las firmaste aparte, y qué hacer con lo que solo se dijo en la oficina."
app: true
...
faq:
  - q: "¿Qué pasa si la póliza no coincide con lo que me ofrecieron?"
    a: "El artículo 8 de la Ley 50/1980 establece que si el contenido de la póliza difiere de la proposición de seguro o de las cláusulas acordadas, el tomador puede reclamar a la aseguradora en el plazo de un mes desde la entrega de la póliza para que subsane la divergencia. Transcurrido ese plazo sin reclamar, se estará a lo dispuesto en la póliza. Ese aviso debe figurar en toda póliza."
  - q: "¿Son válidas todas las cláusulas de la póliza?"
    a: "No automáticamente. El artículo 3 exige que las condiciones se redacten de forma clara y precisa, y que las cláusulas limitativas de los derechos de los asegurados se destaquen de modo especial y sean específicamente aceptadas por escrito. Una limitación que no cumpla ambos requisitos no puede oponerse al asegurado."
  - q: "¿Qué diferencia hay entre una cláusula limitativa y una delimitadora?"
    a: "Las delimitadoras definen qué riesgo se cubre y forman parte del objeto del contrato. Las limitativas restringen o condicionan derechos que el asegurado esperaría tener según esa cobertura, y solo esas están sujetas al doble requisito del artículo 3. La distinción la han desarrollado los tribunales y es lo que más se discute en la práctica."
  - q: "¿Me obliga la solicitud que firmé en la oficina?"
    a: "No. El artículo 6 establece que la solicitud de seguro no vincula al solicitante, mientras que la proposición de seguro hecha por el asegurador sí le vincula durante quince días."
  - q: "¿Cuánto tiempo tengo para comunicar un siniestro?"
    a: "El artículo 16 fija un plazo máximo de siete días desde que se conoce el siniestro, salvo que la póliza establezca un plazo más amplio. El incumplimiento permite a la aseguradora reclamar los daños causados por la falta de declaración, no la pérdida automática de la indemnización."
---
...
<p class="pull">Ese momento tiene un plazo, y son treinta días desde que te la entregan.</p>
...
> "Eso entra, no te preocupes."
> "Esa exclusión es para otros casos, en el tuyo no aplica."
> "Con esta cobertura te lo cubren todo."
> "Lo del preexistente es solo si estabas en tratamiento."
