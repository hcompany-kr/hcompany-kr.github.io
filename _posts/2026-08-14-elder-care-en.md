...
ref: elder-care
categories: en
permalink: /blog/en/elder-care/
date: 2026-08-14
eyebrow: Care
title: "A camera in the room and a phone in the pocket are not the same legal question"
description: "State monitoring laws, what consent and signage they require, and why a resident recording their own conversation sits in a different category entirely."
app: true
...
faq:
  - q: "Can I put a camera in my parent's nursing home room?"
    a: "It depends on the state. Roughly seven to ten states have specific electronic monitoring laws — Illinois, Texas, Washington, Oklahoma, Missouri, Minnesota, Virginia and Connecticut among them. Those laws typically require written consent from the resident or their representative, written consent from any roommate, written notice to the facility, and posted signage. The remaining states are a legal grey area."
  - q: "Do those laws cover audio as well as video?"
    a: "Minnesota's law expressly defines electronic monitoring to include an audio recorder. Elsewhere the position varies, and state wiretap statutes apply on top of the monitoring rules. Audio is generally the more restricted of the two."
  - q: "Is covert monitoring allowed?"
    a: "Generally not where a monitoring law exists. Virginia's regulations require a facility to report discovered covert monitoring to the Long-Term Care Ombudsman and the licensing office, and the facility may then require the resident to meet the full requirements for authorized monitoring."
  - q: "Are recordings usable as evidence?"
    a: "Several state laws address admissibility directly, and some provide that recordings made with an authorized camera may be admitted in civil and criminal proceedings. Courts still expect authentication — keeping original files, a simple log of dates and times, and a record of who handled the device."
  - q: "Where do I report suspected abuse or neglect?"
    a: "Every state has a Long-Term Care Ombudsman program, which advocates for residents and investigates complaints, and Adult Protective Services handles abuse reports. Serious situations can also be reported to the state licensing agency or to law enforcement."
---
...
<p class="pull">That question and "can my parent record their own conversation" have completely different answers.</p>
...
[TalkSafe](https://hcompany-kr.github.io/talksafe/en/) works differently.
