...
ref: school-violence
categories: es
permalink: /blog/es/acoso-escolar/
date: 2026-08-12
eyebrow: Escuela
title: "Con indicios razonables, el centro tiene que activar el protocolo"
description: "Qué obliga a un colegio a actuar, qué son las medidas cautelares, cómo acceder al expediente y a quién acudir cuando el centro no responde."
app: true
...
faq:
  - q: "¿Qué diferencia hay entre un conflicto puntual y acoso escolar?"
    a: "El acoso requiere tres condiciones a la vez: intencionalidad de hacer daño, repetición a lo largo del tiempo y un desequilibrio de poder claro, de modo que la víctima no puede defenderse. Una pelea puntual entre dos personas en igualdad de condiciones no encaja en esa definición."
  - q: "¿Quién es el coordinador de bienestar y protección?"
    a: "Es una figura obligatoria en todos los centros educativos desde la Ley Orgánica 8/2021 de protección integral a la infancia y la adolescencia frente a la violencia. Se encarga de velar por la protección del alumnado y de coordinar las actuaciones de convivencia, y es un interlocutor directo cuando se detecta una situación de acoso."
  - q: "¿Qué debe hacer el centro cuando se comunica un posible caso?"
    a: "El equipo directivo y el coordinador de bienestar registran la incidencia e inician actuaciones preliminares. Si de la valoración inicial se desprenden indicios razonables, se activa formalmente el protocolo, se comunica a las familias implicadas y, si procede, a la Inspección Educativa. Durante la investigación el centro está obligado a adoptar medidas cautelares de protección."
  - q: "¿Puedo acceder al expediente del protocolo?"
    a: "Las familias pueden solicitar formalmente el acceso al expediente amparándose en el artículo 53 de la Ley 39/2015 y en el artículo 17 de la Ley 19/2013. Si la solicitud se deniega o no se responde en un mes, cabe reclamación ante el Consejo de Transparencia y Buen Gobierno o recurso de alzada."
  - q: "¿Qué hago si el centro no actúa?"
    a: "La Inspección Educativa es la autoridad superior a la que pueden recurrir las familias cuando el centro no responde adecuadamente. Entre sus competencias está velar por el cumplimiento de la legislación vigente y puede mediar entre las familias y los centros. Si la situación persiste, cabe acudir con toda la documentación y, en su caso, presentar denuncia."
---
...
<p class="pull">Conocer el recorrido de antemano es lo que evita improvisar en ese momento.</p>
...
[TalkSafe](https://hcompany-kr.github.io/talksafe/es/) sirve para cubrir parte de ese hueco.
