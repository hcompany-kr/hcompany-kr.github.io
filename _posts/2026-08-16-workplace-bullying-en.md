...
categories: en
permalink: /blog/en/workplace-bullying/
date: 2026-08-16
eyebrow: Work
title: "Most workplace bullying is perfectly legal"
description: "There is no federal or state anti-bullying law. What makes it actionable, why writing your complaint down changes the employer's position, and what to do when none of that applies."
app: true
...
faq:
  - q: "Is workplace bullying illegal in the United States?"
    a: "Generally no. No federal statute prohibits a manager from berating you or a team from freezing you out. Bullying becomes unlawful only when it targets a protected characteristic such as race, sex, age, religion or disability, when it is severe or pervasive enough to create a hostile work environment, or when it is retaliation for protected activity."
  - q: "Are there any state anti-bullying laws?"
    a: "The Healthy Workplace Bill, which would allow claims for abusive conduct without proving a protected-class connection, has been introduced in dozens of state legislatures over two decades and has not been enacted in full form by any state. Puerto Rico enacted a standalone workplace harassment law in 2020."
  - q: "Does it matter whether I complain verbally or in writing?"
    a: "It matters a great deal. A written complaint creates a dated record and removes the employer's ability to later claim it was unaware of the situation. An unacknowledged verbal complaint is far easier for a company to ignore."
  - q: "What if I am punished for complaining?"
    a: "Retaliation for protected activity is unlawful in its own right and can be established even where the underlying claim does not succeed. This is why the timing of any change in your treatment after you complain is worth documenting."
  - q: "How long do I have to file?"
    a: "EEOC charges are generally subject to a 180-day deadline, extended to 300 days where a state or local fair employment practices agency enforces a law prohibiting the same conduct. The clock does not wait while an internal process runs."
---
...
<p class="pull">A manager can be systematically cruel without violating any federal statute.</p>
...
[TalkSafe](https://hcompany-kr.github.io/talksafe/en/) removes that step. You set a few words in advance and recording starts when one of them is heard. **It starts with the screen locked**, from a pocket, with nothing to open.
...
**One caution.** Recording consent rules vary by state, and about a dozen require everyone's consent — [covered separately](https://hcompany-kr.github.io/blog/en/recording-consent-law/). Leaving a recorder running all day is a different matter again: it captures conversations you are not a party to, which is a federal offense under 18 U.S.C. §2511. Starting only on a chosen word keeps that window small.
