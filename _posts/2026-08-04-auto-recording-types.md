...
이 글은 앱 안에서 무엇이 녹음을 시작시키는지에 관한 것입니다. 기기까지 포함해 무엇으로 녹음할지 고르는 문제는 [녹음기를 가르는 건 음질이 아니라 '언제 시작되는가'입니다](/blog/ko/choosing-a-recorder/)에서 따로 다뤘습니다.

통화 녹음만 따로 보시려면, 서드파티 앱이 왜 전부 막혔고 기본 전화 앱은 왜 되는지를 [통화 녹음 앱이 전부 안 되는 이유](/blog/ko/call-recording-android/)에 정리했습니다.
